...
# cc = 'btcusd'
# SOCKET = f"wss://stream.binance.com:9443/ws/{cc}t@kline_1m"

def select_crypto(cc):
...
def update_graph(cc):
    ...
    ax.legend([f"Last price: {ydata}$"])

    fig.canvas.draw()
    plt.pause(0.1)
    run(cc)
    """
    This function will create a plot
    """
